$(document).ready(function(){
	...
	// Start ADV Section
	$("#vedios").click(function(){
		var getmodal = $(this).data("bs-target");
		var getvediosrc = $(this).data('vedio');
		var vediourlwidthauto = getvediosrc+"?aurtoplay=1";

		$(getmodal +" iframe").attr("src",vediourlwidthauto);
		
		$(getmodal + "button.btn-close").click(function(){
			$(getmodal) + " iframe".attr("src",getvediosrc);
		});
	...
	// copy lightslider page eg
	$("#lightslider").lightSlider({
		// auto:true,
		item:4,
        loop:true,
        slideMove:1, // bl na pone sr ywat mhr lae pyw dr
        speed:600
	}).play();
